...
| `npx -y node@20.19.0 packages/local-pii/scripts/verify-import-matrix.mjs`   | Pass            | Direct export-target and isolation matrix on the lowest declared Node release                                                                           |
| `npx -y node@22.12.0 packages/local-pii/scripts/verify-import-matrix.mjs`   | Pass            | Direct export-target and isolation matrix on the next admitted Node major floor                                                                         |
