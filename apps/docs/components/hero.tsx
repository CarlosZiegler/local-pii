    ...
    <div className="rounded-2xl border bg-card p-1 shadow-sm">
      <div className="grid grid-cols-1 gap-px overflow-hidden rounded-xl md:grid-cols-[1fr_auto_1fr]">
        ...
        <div className="bg-background p-4">
          <div className="mb-2 flex items-center gap-1.5 text-[0.7rem] font-semibold uppercase tracking-wider text-muted-foreground">
            <span className="size-1.5 rounded-full bg-emerald-500" /> on your device
          </div>
        ...
        <div className="relative flex items-center justify-center bg-background px-2 py-3 md:flex-col">
          <div className="absolute inset-x-4 top-1/2 h-px bg-gradient-to-r from-transparent via-amber-500/50 to-transparent md:inset-y-4 md:inset-x-auto md:left-1/2 md:h-auto md:w-px md:bg-gradient-to-b" />
          <span className="relative rounded-full border border-amber-500/40 bg-background px-2 py-0.5 font-mono text-[0.62rem] uppercase tracking-wider text-amber-600 dark:text-amber-400">
            leaves →
          </span>
        </div>
        ...
        <div className="bg-background p-4">
          <div className="mb-2 flex items-center gap-1.5 text-[0.7rem] font-semibold uppercase tracking-wider text-muted-foreground">
            <span className="size-1.5 rounded-full bg-amber-500" /> what the LLM sees
          </div>
